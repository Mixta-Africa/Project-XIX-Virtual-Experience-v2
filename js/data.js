...
export const VIEWPOINTS = {
  ...
  field_centre: {
    ...
    yaw: 0,
    pitch: 0,
    caption: "Standing at the halfway line, facing north",
    icon: "pitch",
  },
  field_south: {
    label: "South Goal",
    ...
    yaw: Math.PI,
    pitch: 0,
    caption: "South goal line — Clubhouse behind you",
    icon: "pitch",
  },
  clubhouse: {
    label: "Clubhouse",
    ...
    yaw: Math.PI,
    pitch: -0.05,
    caption: "Clubhouse terrace — the social heart of Project XIX",
    icon: "clubhouse",
    zoneKey: "clubhouse",
  },
  lake_north: {
    ...
    yaw: 0,
    pitch: 0,
    caption: "Proposed lake edge — north of the polo field",
    icon: "lake",
    zoneKey: "lake",
  },
  villa_west: {
    ...
    yaw: Math.PI / 2,
    pitch: 0,
    caption: "Premium Villa row — west of the polo field",
    icon: "villa",
    zoneKey: "villas",
  },
  stables: {
    ...
    yaw: -Math.PI / 4,
    pitch: 0,
    caption: "Horse Stables — equestrian operations compound",
    icon: "stables",
    zoneKey: "stables",
  },
  training: {
    ...
    yaw: -Math.PI / 2,
    pitch: 0,
    caption: "Training Field — polo academy, 30/40/60-yard zones",
    icon: "pitch",
    zoneKey: "training",
  },
  lofts: {
    ...
    yaw: 0,
    pitch: 0,
    caption: "2-Bedroom Loft Terrace — south residential precinct",
    icon: "loft",
    zoneKey: "lofts",
  },
  aerial: {
    ...
    yaw: 0,
    pitch: -Math.PI / 2,
    caption: "Overview — 18.8 hectare estate, Lakowe",
    icon: "aerial",
  },
};
